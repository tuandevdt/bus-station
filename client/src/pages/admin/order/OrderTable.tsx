      ...
      <Table>
        <TableHead>
          <TableRow>
            ...
            <TableCell><strong>Điểm xuất phát</strong></TableCell>
            <TableCell><strong>Điểm kết thúc</strong></TableCell>
            <TableCell><strong>Mã chuyến</strong></TableCell>
            <TableCell><strong>Ngày khởi hành</strong></TableCell>
            <TableCell><strong>Số lượng vé</strong></TableCell>
            <TableCell><strong>Tổng tiền</strong></TableCell>
            <TableCell><strong>Trạng thái</strong></TableCell>
            <TableCell align="center"><strong>Xem chi tiết</strong></TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {orders.map((order) => (
            <TableRow key={order.id} hover>
              ...
              <TableCell>{new Date(order.departureDate).toLocaleDateString('vi-VN')}</TableCell>
